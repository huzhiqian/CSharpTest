...
namespace RectButton
{
    [ToolboxItemAttribute(true)]//不加这个将不能在常规中添加该控件
    public partial class RectButton:Button
    {
        ...
        public bool IsPressed
        {
            get
            {
                return buttonOnPressed;
            }
            private set
            {
                buttonOnPressed = value;
                OnPressStateChnaged(this, new EventArgs());
            }
        }
        ...
        protected virtual void OnPressStateChnaged(object sender, EventArgs e)
        {
            this.PressStateChanged?.Invoke(sender, e);
        }
        ...
        public event EventHandler PressStateChanged;
    }

    public partial class RectButton
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
