   ...
   public class ResetState:State
    {
        ...
        {
            if (machineContext.MachineState == MachineStateConstant.UnReset)
            {
                MessageBox.Show("复位设备");
                machineContext.SetState(new StopState(),MachineStateConstant.Stop);
            }
